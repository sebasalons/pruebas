	...
	appearances:
	{
		...
		"menubar-button":
		{
			...
			style: function(states)
			{
				return {
					...
					textColor: states.pressed || states.hovered ? "#FFFFFF": undefined,
					padding: [ 3, 8 ]
				};
			}
		},
		...
		*/
		...
		"tabview-page/button":
		{
			...
			style: function(states)
			{
				...
				return {
					...
					textColor: states.checked ? "text-active": states.disabled? "text-disabled": "text-inactive"
				};
			}
		},
		...
		"tabview-page/button/close-button":
		{
			...
			{
				return {
					icon: "eyetheme/decoration/window/close-active.png"
				};
			}
		},
		...
		*/
		...
		"standard-window/topbar-search": "searchfield"
	}
});
