...
qx.Class.define(m,{extend:qx.application.Native,members:{__wP:null,main:function(){qx.application.Native.prototype.main.call(this);
var r=qx.util.ResourceManager.getInstance();
this.__wP=[g,k,h,r.toUri(f)];
...
this.window1=qx.bom.Window.open(this.__wP[0],j,x);
},this);
...
this.window2=qx.bom.Window.open(this.__wP[3],a,y,true);
},this);
...
this.window3=qx.bom.Window.open(this.__wP[0],i,A,true,false);
},this);
...
qx.Class.define(l,{statics:{__wQ:null,__wR:null,__wS:null,__wT:{"top":b,left:d,width:j,height:q,scrollbars:h,resizable:s},__wU:{"top":1,left:1,width:1,height:1,dependent:1,resizable:1,status:1,location:1,menubar:1,scrollbars:1,toolbar:1},__wV:function(){return window.showModalDialog!=null;
},open:function(t,name,u,v,w){if(t==null){t=i;
}
if(name==null){name=f+new Date().getTime();
}
if(w==null){w=true;
}var x=this.__wW(u,v&&w);

if(v){if(this.__wV()&&w){return window.showModalDialog(t,[window.self],x);
}else{this.getBlocker().block();

if(this.__wS==null){this.__wS=new qx.event.Timer(500);
this.__wS.addListener(k,this.__wX,this);
}this.__wR=window.open(t,name,x);
this.__wS.restart();
return this.__wR;
}}else{return window.open(t,name,x);
}},__wW:function(y,z){var A;
var D;
var B=[];

if(z&&this.__wV()){for(var C in y){if(qx.bom.Window.__wT[C]){var E=n;

if(C!=e&&C!=s){E=m;
}D=qx.bom.Window.__wT[C]+g+y[C]+E;
B.push(D);
}else{qx.log.Logger.warn("Option '"+C+"' is not supported for modal windows.");
}}A=B.join(c);
}else{for(var C in y){if(qx.bom.Window.__wU[C]){if(qx.lang.Type.isBoolean(y[C])){D=C+r+(y[C]?o:p);
}else{D=C+r+y[C];
}B.push(D);
}else{qx.log.Logger.warn("Option '"+C+"' is not supported for native windows.");
}}A=B.join(a);
}return A;
},__wX:function(){if(this.isClosed(this.__wR)){this.getBlocker().unblock();
this.__wS.stop();
}},getBlocker:function(){if(this.__wQ==null){this.__wQ=new qx.bom.Blocker;
}return this.__wQ;
...
(function(){var p="px",o="mshtml",n="0px",m="qx.client",l="resize",k="backgroundColor",j="block",i="zIndex",h="transparent",g="src",c="allowTransparency",f="div",d="javascript:false;",b="qx.bom.Blocker",a="absolute";
qx.Class.define(b,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__wE();
},members:{__wx:null,__wy:null,__wz:null,__wA:false,__wB:10000,__wC:0,__wD:h,block:function(q){if(!this.__wA){this.__wz=q;
var r=this.__wH();
this.__wI(r);
this.__wA=true;
}},unblock:function(){if(this.__wA){this.__wJ();
this.__wA=false;
}},isBlocked:function(){return this.__wA;
},getBlockerElement:function(){return this.__wy;
},setBlockerColor:function(s){qx.bom.element.Style.set(this.__wy,k,s);
},getBlockerColor:function(){return qx.bom.element.Style.get(this.__wy,k);
},setBlockerOpacity:function(t){qx.bom.element.Opacity.set(this.__wy,t);
},getBlockerOpacity:function(){return qx.bom.element.Opacity.get(this.__wy);
},setBlockerZIndex:function(u){qx.bom.element.Style.set(this.__wy,i,u);
},getBlockerZIndex:function(){return qx.bom.element.Style.get(this.__wy,i);
},__wE:function(){this.__wF();

if(qx.core.Variant.isSet(m,o)){this.__wG();
}qx.event.Registration.addListener(window,l,this.__wK,this);
},__wF:function(){this.__wy=qx.bom.Element.create(f);
qx.bom.element.Style.setStyles(this.__wy,{display:j,opacity:this.__wC,backgroundColor:this.__wD});
this.setBlockerZIndex(this.__wB);
},__wG:function(){this.__wx=qx.bom.Iframe.create();
qx.bom.element.Attribute.set(this.__wx,c,false);
qx.bom.element.Attribute.set(this.__wx,g,d);
qx.bom.element.Style.setStyles(this.__wx,{display:j,opacity:this.__wC});
},__wH:function(){var v={position:a};

if(this.__wM()){v.left=n;
v.top=n;
v.right=null;
v.bottom=null;
v.width=qx.bom.Document.getWidth()+p;
v.height=qx.bom.Document.getHeight()+p;
}else{v.width=qx.bom.element.Dimension.getWidth(this.__wz)+p;
v.height=qx.bom.element.Dimension.getHeight(this.__wz)+p;
v.left=qx.bom.element.Location.getLeft(this.__wz)+p;
v.top=qx.bom.element.Location.getTop(this.__wz)+p;
}return v;
},__wI:function(w){var x=document.body;
qx.bom.element.Style.setStyles(this.__wy,w);
qx.dom.Element.insertEnd(this.__wy,x);

if(qx.core.Variant.isSet(m,o)){w.zIndex=this.getBlockerZIndex()-1;
qx.bom.element.Style.setStyles(this.__wx,w);
qx.dom.Element.insertEnd(this.__wx,document.body);
}},__wJ:function(){qx.dom.Element.remove(this.__wy);

if(qx.core.Variant.isSet(m,o)){qx.dom.Element.remove(this.__wx);
}},__wK:function(e){if(this.__wM()){this.__wL({width:n,height:n});
qx.event.Timer.once(function(){var y={width:qx.bom.Document.getWidth()+p,height:qx.bom.Document.getHeight()+p};
this.__wL(y);
},this,0);
}},__wL:function(z){qx.bom.element.Style.setStyles(this.__wy,z);

if(qx.core.Variant.isSet(m,o)){qx.bom.element.Style.setStyles(this.__wx,z);
}},__wM:function(){return (this.__wz==null||qx.dom.Node.isWindow(this.__wz)||qx.dom.Node.isDocument(this.__wz));
}},destruct:function(){qx.event.Registration.removeListener(window,l,this.__wK,this);
this.__wx=this.__wy=this.__wz=null;
}});
})();
