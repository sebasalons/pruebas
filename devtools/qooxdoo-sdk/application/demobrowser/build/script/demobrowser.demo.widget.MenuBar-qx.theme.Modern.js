...
(function(){var t="keypress",s="interval",r="keydown",q="mousedown",p="keyup",o="blur",n="Enter",m="__mL",l="__mK",k="__mJ",c="Up",j="Escape",g="qx.ui.menu.Manager",b="Left",a="Down",f="Right",d="singleton",h="Space";
...
this.__mK.addListener(s,this._onOpenInterval,this);
this.__mL=new qx.event.Timer;
this.__mL.addListener(s,this._onCloseInterval,this);
},members:{__mM:null,__mN:null,__mK:null,__mL:null,__mJ:null,_getChild:function(w,x,y,z){var A=w.getChildren();
var length=A.length;
var B;
...
}},hideAll:function(){var I=this.__mJ;

if(I){for(var i=I.length-1;i>=0;i--){I[i].exclude();
}}},getActiveMenu:function(){var J=this.__mJ;
return J.length>0?J[J.length-1]:null;
},scheduleOpen:function(K){this.cancelClose(K);
if(K.isVisible()){if(this.__mM){this.cancelOpen(this.__mM);
}}else if(this.__mM!=K){this.__mM=K;
this.__mK.restartWith(K.getOpenInterval());
}},scheduleClose:function(L){this.cancelOpen(L);
if(!L.isVisible()){if(this.__mN){this.cancelClose(this.__mN);
}}else if(this.__mN!=L){this.__mN=L;
this.__mL.restartWith(L.getCloseInterval());
}},cancelOpen:function(M){if(this.__mM==M){this.__mK.stop();
this.__mM=null;
}},cancelClose:function(N){if(this.__mN==N){this.__mL.stop();
this.__mN=null;
...
}if(this.__mJ.length>0&&!this._isInMenu(O)){this.hideAll();
}},__mO:{"Enter":1,"Space":1},__mP:{"Escape":1,"Up":1,"Down":1,"Left":1,"Right":1},_onKeyUpDown:function(e){var P=this.getActiveMenu();

if(!P){return;
}var Q=e.getKeyIdentifier();

if(this.__mP[Q]||(this.__mO[Q]&&P.getSelectedButton())){e.stopPropagation();
...
}},__mW:function(t){while(!(t instanceof qx.ui.menu.Menu)){t=t.getLayoutParent();
}return t;
