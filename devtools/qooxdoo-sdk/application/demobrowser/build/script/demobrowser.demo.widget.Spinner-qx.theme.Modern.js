...
this._applyValue(this.__Au,undefined);
...
}}}},_onKeyDown:function(e){switch(e.getKeyIdentifier()){case d:this.__Av=true;
case J:this.getChildControl(h).press();
break;
case H:this.__Aw=true;
...
}else{this._applyValue(this.__Au,undefined);
...
},_countUp:function(){if(this.__Av){var bB=this.getValue()+this.getPageStep();
...
},_countDown:function(){if(this.__Aw){var bD=this.getValue()-this.getPageStep();
