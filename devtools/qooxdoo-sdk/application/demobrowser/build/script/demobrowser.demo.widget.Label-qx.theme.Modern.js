...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.Label-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"c39030231e4e"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
}},properties:{model:{check:f,event:g,apply:b,nullable:true,dereference:true}},members:{__nP:null,__nO:null,_applyModel:function(k,l){for(var i=0;i<this.__nP.length;i++){var t=this.__nP[i][0];
var q=this.__nP[i][1];
var o=this.__nP[i][2];
var r=this.__nP[i][3];
var s=this.__nP[i][4];
var n=this.__nP[i][5];
if(l!=undefined){this.__nR(t,q,o,l);
}if(k!=undefined){this.__nQ(t,q,o,r,s,n);
...
}}}}},addTarget:function(u,v,w,x,y,z){this.__nP.push([u,v,w,x,y,z]);
this.__nQ(u,v,w,x,y,z);
},__nQ:function(A,B,C,D,E,F){if(this.getModel()==null){return;
...
if(this.__nO[I]==undefined){this.__nO[I]=[];
}this.__nO[I].push([G,H,B,C,E,F]);
},removeTarget:function(J,K,L){this.__nR(J,K,L,this.getModel());
for(var i=0;i<this.__nP.length;i++){if(this.__nP[i][0]==J&&this.__nP[i][1]==K&&this.__nP[i][2]==L){this.__nP.splice(i,1);
}}},__nR:function(M,N,O,P){if(!(M instanceof qx.core.Object)){return ;
}var Q=this.__nO[M.toHashCode()];
