...
(function(){var n="Boolean",m="changeInvalidMessage",l="changeSelection",k="String",j="_applyValid",h="",g="changeRequired",f="changeValid",d="__At",c="_applyInvalidMessage",a="qx.ui.form.RadioButtonGroup",b="qx.event.type.Data";
...
}this.__At=new qx.ui.form.RadioGroup();
this.__At.addListener(l,function(e){this.fireDataEvent(l,e.getData(),e.getOldData());
},this);
},properties:{valid:{check:n,init:true,apply:j,event:f},required:{check:n,init:false,event:g},invalidMessage:{check:k,init:h,event:m,apply:c},requiredInvalidMessage:{check:k,nullable:true,event:m}},events:{"changeSelection":b},members:{__At:null,_applyInvalidMessage:function(p,q){var r=this._getChildren();
...
}},getRadioGroup:function(){return this.__At;
},getChildren:function(){return this._getChildren();
},add:function(v,w){this.__At.add(v);
this._add(v,w);
},remove:function(x){this.__At.remove(x);
this._remove(x);
},removeAll:function(){var y=this.__At.getItems();

for(var i=0;i<y.length;i++){this.__At.remove(y[i]);
}this._removeAll();
},getSelection:function(){return this.__At.getSelection();
},setSelection:function(z){return this.__At.setSelection(z);
},resetSelection:function(){return this.__At.resetSelection();
},isSelected:function(A){return this.__At.isSelected(A);
},isSelectionEmpty:function(){return this.__At.isSelectionEmpty();
},getSelectables:function(B){return this.__At.getSelectables(B);
}},destruct:function(){this._disposeObjects(d);
}});
})();
