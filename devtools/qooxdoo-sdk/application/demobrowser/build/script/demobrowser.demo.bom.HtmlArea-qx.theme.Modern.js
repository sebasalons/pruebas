...
qx.Class.define(B,{extend:qx.application.Native,members:{__wY:null,__xa:null,__xb:null,__xc:null,__xd:null,main:function(){qx.application.Native.prototype.main.call(this);
this.__wY=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__wY,{margin:f});
...
this.__xa=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__xa,{width:bR,padding:ca,margin:ca,lineHeight:ca,border:bs});
this.__xb=qx.bom.Element.create(cb);
qx.bom.element.Style.setStyles(this.__xb,{width:bR,height:bQ,border:bs,borderTop:ca,backgroundColor:bI});
qx.dom.Element.insertEnd(this.__xb,this.__wY);
var cw=bP;
this.__xc=new qx.bom.htmlarea.HtmlArea(this.__xb,cw,null,S);
this.__xn();
qx.dom.Element.insertBegin(this.__xa,this.__wY);
qx.dom.Element.insertBegin(cy,this.__wY);
qx.dom.Element.insertBegin(this.__wY,document.body);
},__xe:function(e){var cz=window.prompt(bE,cg);
this.setFontSize(parseInt(cz));
},__xf:function(e){var cA=window.prompt(cf,bp);
this.setTextColor(cA);
},__xg:function(e){var cB=window.prompt(cl,bp);
this.setTextBackgroundColor(cB);
},__xh:function(e){var cC={src:qx.util.ResourceManager.getInstance().toUri(l),border:0,title:bn,alt:bn};
this.insertImage(cC);
},__xi:function(e){var cD=bA+bf+bu+k+bb+cj+bu+J+bc+cj+K+ba;
this.insertHtml(cD);
},__xj:function(e){var cE=window.prompt(v,ck);
this.insertHyperLink(cE);
},__xk:function(e){var cF=window.prompt(cq,cg);
this.insertHtml(cF);
},__xl:function(){var cH=qx.bom.Element.create(cb);
...
return cH;
},__xm:function(){var cP=qx.bom.Element.create(cb);
...
return cP;
},__xn:function(){var cW=[{bold:{text:p,image:F,action:this.__xc.setBold},italic:{text:bO,image:bz,action:this.__xc.setItalic},underline:{text:bB,image:bN,action:this.__xc.setUnderline},strikethrough:{text:bC,image:r,action:this.__xc.setStrikeThrough},removeFormat:{text:R,image:I,action:this.__xc.removeFormat}},{alignLeft:{text:m,image:A,action:this.__xc.setJustifyLeft},alignCenter:{text:bh,image:cp,action:this.__xc.setJustifyCenter},alignRight:{text:bL,image:G,action:this.__xc.setJustifyRight},alignJustify:{text:cn,image:bx,action:this.__xc.setJustifyFull}},{fontFamily:{custom:this.__xl},fontSize:{custom:this.__xm},fontColor:{text:P,image:Q,action:this.__xf},textBackgroundColor:{text:cv,image:bM,action:this.__xg}},{indent:{text:bK,image:b,action:this.__xc.insertIndent},outdent:{text:bD,image:be,action:this.__xc.insertOutdent}},{insertImage:{text:bd,image:T,action:this.__xh},insertTable:{text:ce,image:O,action:this.__xi},insertLink:{text:cu,image:D,action:this.__xj},insertHTML:{text:E,image:cm,action:this.__xk},insertHR:{text:ct,image:cs,action:this.__xc.insertHorizontalRuler}},{ol:{text:C,image:a,action:this.__xc.insertOrderedList},ul:{text:bF,image:cr,action:this.__xc.insertUnorderedList}},{undo:{text:bl,image:H,action:this.__xc.undo},redo:{text:q,image:bi,action:this.__xc.redo}}];
var cY,dd,cV,db;
...
}qx.event.Registration.addListener(cV,X,dc.action,this.__xc);
}qx.dom.Element.insertEnd(cV,cY);
}qx.dom.Element.insertEnd(cY,this.__xa);
}qx.dom.Element.insertEnd(qx.bom.Element.create(o,{style:ch}),this.__xa);
}}});
})();
...
this.__xo=qx.bom.htmlarea.HtmlArea.__xr(eF);
if(qx.lang.Type.isString(eE)){this.__xp=eE;
...
eJ._keyCodeToIdentifierMap[115]=em;
eJ._keyCodeToIdentifierMap[120]=dg;
}this.__xq=this.__xY();
},events:{"load":dP,"loadingError":dR,"messengerContent":dR,"cursorContext":dR,"ready":dP,"readyAfterInvalid":dP,"focused":dP,"focusOut":dP,"contextmenu":dR,"undoRedoState":dR},statics:{simpleLinebreak:cd,EMPTY_DIV:"<div></div>",GetWordsRegExp:/([^\u0000-\u0040\u005b-\u005f\u007b-\u007f]|['])+/g,CleanupWordsRegExp:/[\u0000-\u0040]/gi,hotkeyInfo:{bold:{method:cG},italic:{method:eh},underline:{method:bj},undo:{method:eA},redo:{method:ds}},__xr:function(eK){if(eK==null||eK==dU){return dU;
}else if(typeof eK==ci){var eL=dU;

for(var i in eK){eL+=i+D+eK[i]+dm;
}return eL;
}else{return eK;
}},__xs:function(eM){var eN={};
var a=eM.split(es);
var i;
...
},__xt:function(eR,eS,eT,eU){var fa=[];

switch(eR.nodeType){case 1:case 11:var i;
var eX=eR.tagName.toLowerCase();
var fc={};
var eV={};
var closed=(!(eR.hasChildNodes()||qx.bom.htmlarea.HtmlArea.__xu(eR)));

if(eS){if(qx.core.Variant.isSet(dV,dT)){if(eX==dr&&eR.className&&eR.className==C){for(i=eR.firstChild;i;i=i.nextSibling){fa.push(qx.bom.htmlarea.HtmlArea.__xt(i,true,eT,eU));
}return fa.join(dU);
...
}if(fc.style!==undefined){eV=qx.bom.htmlarea.HtmlArea.__xs(fc.style);
delete fc.style;
...
}if(!qx.lang.Object.isEmpty(eV)){fa.push(cS);

for(var name in eV){var fd=eV[name];
fa.push(name,u,fd.toString().replace(new RegExp(cs,eu),S),es);
}fa.push(cs);
}fa.push(closed?cz:T);
}}for(i=eR.firstChild;i;i=i.nextSibling){fa.push(qx.bom.htmlarea.HtmlArea.__xt(i,true,eT,eU));
}if(eS&&!closed&&eX){fa.push(cD,eX,T);
}break;
case 3:fa.push(eT?eR.data:qx.bom.htmlarea.HtmlArea.__xv(eR.data));
break;
case 8:fa.push(bJ,eR.data,bX);
break;
}return fa.join(dU);
},closingTags:bx,__xu:function(fe){return (qx.bom.htmlarea.HtmlArea.closingTags.indexOf(dO+fe.tagName+dO)!=-1);
},__xv:function(s){s=s.replace(/&/ig,dB);
s=s.replace(/</ig,cQ);
s=s.replace(/>/ig,cJ);
s=s.replace(/\x22/ig,cx);
...
}},properties:{contentType:{check:Q,init:m},messengerMode:{check:dN,init:false},insertParagraphOnLinebreak:{check:dN,init:true},insertLinebreakOnCtrlEnter:{check:dN,init:true},postProcess:{check:bg,nullable:true,init:null},useUndoRedo:{check:dN,init:true},nativeContextMenu:{check:dN,init:false},defaultFontFamily:{check:Q,init:bV},defaultFontSize:{check:cY,init:4}},members:{__xw:null,__xx:false,__xy:false,__xz:false,__xA:false,__xB:false,__xq:null,__xC:null,__xD:null,__xE:null,__xF:null,__xo:null,__xG:null,__xH:null,__xI:false,__xJ:false,__xK:function(fl){if(qx.dom.Node.isElement(fl)&&qx.dom.Node.isNodeName(fl,dr)){this.__xw=fl;
}},_createAndAddIframe:function(fm){this.__xF=qx.bom.Iframe.create();
qx.bom.Iframe.setSource(this.__xF,fm);
if(qx.core.Variant.isSet(dV,dT)){qx.bom.element.Attribute.set(this.__xF,eq,cw);
}else{qx.bom.element.Style.set(this.__xF,dG,er);
}qx.bom.element.Style.setStyles(this.__xF,{width:p,height:p});
qx.dom.Element.insertBegin(this.__xF,this.__xw);
},_getIframeDocument:function(){return qx.bom.Iframe.getDocument(this.__xF);
},_getIframeWindow:function(){return qx.bom.Iframe.getWindow(this.__xF);
},_addIframeLoadListener:function(){qx.event.Registration.addListener(this.__xF,Y,this._loaded,this);
},__xL:function(){this.__xG={"xhtml":{doctype:cO+dE+B+ej+ce+cM,html:ek+bL,meta:d,style:qx.core.Variant.select(dV,{"mshtml":cc+dK,"default":dJ+ep}),contentStyle:dL,body:dy,footer:O}};
},__xp:dU,getIframeObject:function(){return this.__xF;
},getCommandManager:function(){return this.__xq;
},setValue:function(fn){if(qx.lang.Type.isString(fn)){this.__xp=fn;
var fo=this._getIframeDocument();

if(fo&&fo.body){fo.body.innerHTML=this.__xM(fn);
}}},__xM:function(fp){var fs=dU;

if(qx.core.Variant.isSet(dV,dS)){if(qx.bom.client.Browser.VERSION<=2){fs+=H;
}}var ft=fp.length==0?cV:dU;
var fr=qx.core.Variant.isSet(dV,dt)?bk:cT;
var fq=de+b+this.getDefaultFontFamily()+x+cR+fr+bK+this.getDefaultFontSize()+x+fs+fp+ft+df+by+h;
return fq;
},getValue:function(){return this.__xp;
},getComputedValue:function(fu){return this.getHtml(fu);
},getCompleteHtml:function(){var fw=this.__xG[this.getContentType()];
var fv=fw.html+r+fw.meta+bw+fw.contentStyle+br+q;
fv+=bS+this.__xN()+bM;
fv+=this.getHtml()+O;
return fv;
},__xN:function(){var fz=[bz,A,dd,bI,ba,bf,F,n,dD,cv,g,bU,dj,cb];
...
},getContentDocument:function(){if(this.__xx){return this._getIframeDocument();
}},getContentBody:function(){if(this.__xx){return this._getIframeDocument().body;
}},getContentWindow:function(){if(this.__xx){return this._getIframeWindow();
}},getWords:function(fE){if(!fE){fE=this.getContentBody();
}
if(!fE){return [];
}var fG=fE.cloneNode(true);
fG.innerHTML=fG.innerHTML.replace(/>/gi,G);
...
},__xO:0,__xP:function(){var fT=this._getIframeDocument();
if(!fT){this.__xO++;

if(this.__xO>5){this.error('cant load HtmlArea. Document is not available. '+fT);
this.fireDataEvent(ea);
}else{{};
qx.event.Timer.once(function(){this.__xP();
},this,0);
}}else{this.__xO=0;
this._onDocumentIsReady();
}},_loaded:function(e){if(this.__xz){return;
}
if(this.__xy){this.__xQ();
return;
}if(qx.core.Variant.isSet(dV,dT)){this.__xP();
}else{this._onDocumentIsReady();
}},isReady:function(){return this.__xx;
...
if(!qx.core.Variant.isSet(dV,cu)){this.__xU();
}if(!qx.core.Variant.isSet(dV,dT)){this.setEditable(true);
}this.__xx=true;
this.__xq=fU;
...
if(fV){if(qx.bom.client.Engine.VERSION>=cU){fV.designMode=dI;
fV.body.contentEditable=false;
fV.body.contentEditable=true;
}else{fV.body.contentEditable=true;
this.__yb(true);
}}},"default":qx.lang.Function.empty}),invalidateEditor:qx.core.Variant.select(dV,{"gecko":function(){this.__xz=false;
this.__xx=false;
this.__xy=true;
},"default":function(){}}),__xQ:qx.core.Variant.select(dV,{"gecko":function(){this.__xT();
this.__xU();
this.__xq.setContentDocument(this._getIframeDocument());
...
this.__xy=false;
this.fireEvent(cC);
},"default":function(){}}),__xR:function(fW){var fY=dU;
...
},__xS:function(gb){var gc=qx.bom.client.Engine.GECKO?dz:dU;
var gd=this.__xG[this.getContentType()];
var ge=r+gd.meta+bw+gc+gd.style+gd.contentStyle+this.__xo+br+q;
var content=gd.body+gb;
return gd.html+ge+content+gd.footer;
},__xT:function(){var gg=this.__xM(this.getValue());

if(qx.lang.Type.isString(gg)){var gf=this._getIframeDocument();

try{gf.open(ca,true);
gf.write(this.__xS(gg));
gf.close();
}catch(e){this.error("cant open document on source '"+qx.bom.Iframe.queryCurrentUrl(this.__xF)+"'",e);
this.fireDataEvent(ea,e);
}}},__xU:function(){this.__xV();
this.__xX();
this.__xW();
},__xV:function(){var gi=qx.event.Registration;
...
},__xW:function(){var gl=qx.event.Registration;
...
},__xX:function(){var go=qx.event.Registration;
...
},__xY:function(){if(this.__xC==null){this.__xC={execute:function(gp,gq){this.stackedCommands=true;
this.commandStack.push({command:gp,value:gq});
},commandStack:[],stackedCommands:false};
}this.__xC.stackedCommands=false;
return this.__xC;
},__ya:function(){var gr=this.__xC;

if(gr!=null&&gr.stackedCommands){var gs=gr.commandStack;

if(gs!=null){for(var i=0,j=gs.length;i<j;i++){this.__xq.execute(gs[i].command,gs[i].value);
}}}},__yb:function(gt){var gu=this._getIframeDocument();

if(this.__xz&&gu){try{if(qx.core.Variant.isSet(dV,dS)){gu.designMode=(gt!==false)?w:dq;
}gu.designMode=(gt!==false)?dq:w;
}catch(e){}}},setEditable:function(gv){if(this.__xz){this.__yb(true);
...
gw.execCommand(ch,false,false);
}catch(gy){if(!this.__xx){this.error("Failed to enable rich edit functionality");
this.fireDataEvent(ea,gy);
}else{throw new Error("Failed to enable rich edit functionality");
}}}}this.__xA=gv;
}},getEditable:function(){return this.__xA;
},isEditable:function(){return this.__xA;
},__yc:false,_handleKeyUp:function(e){var gz=e.getKeyIdentifier().toLowerCase();
this.__xD=e;

if(false&&qx.core.Setting.get(co)==cn){this.debug(e.getType()+" | "+gz);
}if(qx.core.Variant.isSet(dV,dH)){if(this.__yc){switch(gz){case ct:if(this.getInsertLinebreakOnCtrlEnter()){if(qx.core.Variant.isSet(dV,bD)){this.__yd();
e.preventDefault();
e.stopPropagation();
}else{var gA=this.__yn(this.getSelection());

if(gA){gA.collapse(true);
gA.pasteHTML(bm);
}}this.__yi();
}break;
case bq:this.__yc=false;
return;
break;
}}}else if(qx.core.Variant.isSet(dV,dS)){switch(gz){case cr:case cp:case bt:case y:case dX:case ey:case R:case eg:case du:this.__xB=(this.getFocusNode()==this.getContentBody().firstChild);
break;
}}},__yd:function(){var gB=this.getSelection();
var gC=dU;
if(gB&&(gB.focusNode.textContent==dU||gB.focusNode.parentElement.tagName==I)){gC=bG;
}this.__xq.execute(ck,gC+qx.bom.htmlarea.HtmlArea.simpleLinebreak);
},_handleKeyDown:qx.core.Variant.select(dV,{"mshtml|webkit":function(e){var gD=e.getKeyIdentifier().toLowerCase();

if(false&&qx.core.Setting.get(co)==cn){}if(this.__yc&&(gD==P||gD==dp||gD==dY||gD==bs||gD==dv||gD==t)){e.preventDefault();
e.stopPropagation();
}if(gD==bq){this.__yc=true;
...
}if(this.__xI){var gP=!(qx.core.Variant.isSet(dV,dT)&&gE==ct)||!(qx.core.Variant.isSet(dV,dS)&&gE==ct);
...
e.stopPropagation();
var gN=new qx.event.type.Data(da,this.getComputedValue());
...
if(qx.core.Variant.isSet(dV,dS)){if(this.__yl()){this.insertHtml(bh);
this.__yi();
return;
}this.insertHtml(cg);
...
}if(qx.core.Variant.isSet(dV,dT)){if(!this.getInsertParagraphOnLinebreak()){if(this.__xq.execute(ck,qx.bom.htmlarea.HtmlArea.simpleLinebreak)){this.__yi();
e.preventDefault();
e.stopPropagation();
...
if(this.__yl()){this.__yi();
return;
}if(this.__ym()){this.__yi();
return;
}while(!qx.dom.Node.isNodeName(gF,ee)){if(qx.dom.Node.isNodeName(gF,bA)){this.__yi();
return;
}gF=gF.parentNode;
}}this.__xq.insertParagraphOnLinebreak();
e.preventDefault();
e.stopPropagation();
this.__yi();
this.__xI=true;
}}else if(qx.core.Variant.isSet(dV,bD)){if(this.getInsertParagraphOnLinebreak()&&gH){this.__yd();
e.preventDefault();
e.stopPropagation();
this.__yi();
}}break;
case bt:if(qx.bom.client.Engine.GECKO&&qx.bom.client.Engine.FULLVERSION<1.9&&gH){var gO=this.getSelection();
if(gO&&gO.focusNode==gI.body.firstChild){if(this.__xB){if(gO.focusOffset!=0){gO.extend(gO.focusNode,0);
}}}}this.__yi();
break;
...
if(gL&&gO){while(gM=gL.iterateNext()){if(gM&&gM.parentNode&&gM.parentNode.tagName!=W){try{gO.extend(gM,0);

if(!this.isSelectionCollapsed()){gO.collapseToStart();
}}catch(e){}break;
}}}}}}this.__yi();
break;
case cr:case cp:case y:case dX:case ey:case R:case eg:case du:this.__yi();
break;
case dY:if(gG){this.__ye(bO,true);
}break;
case dv:case t:if(gG){this.__ye(J,true);
}break;
case bs:if(gG){this.__ye(bN,true);
}break;
case P:if(gG&&!gH){this.__ye(bB,true);
}else if(gG&&gH){this.__ye(v,true);
}break;
case dp:if(gG){this.__ye(v,true);
}break;
case dl:if(gG){this.selectAll();
}break;
}this.__xD=null;
},__ye:function(gQ,gR){var gT=null;
...
if(gR){this.__xD.preventDefault();
this.__xD.stopPropagation();
}
if(this.isSelectionCollapsed()){this.__xI=true;
}this.__yi();
}},_handleFocusEvent:function(e){this.__xE=null;
...
},_handleBlurEvent:function(e){this.__xp=this.getComputedValue();
},_handleFocusOutEvent:function(e){this.__yc=false;

if(this.__xE==null){this.__xE=this.getSelectedHtml();
}this.fireEvent(l);
},_handleMouseUpOnBody:function(e){if(false&&qx.core.Setting.get(co)==cn){this.debug("handleMouse "+e.getType());
}this.__xJ=true;
this.__yi();
},_handleMouseUpOnDocument:qx.core.Variant.select(dV,{"mshtml":qx.lang.Function.empty,"default":function(e){if(!this.__xJ){qx.bom.Element.activate(this.getContentBody());
}this.__xJ=false;
}}),_handleContextMenuEvent:function(e){if(!this.getNativeContextMenu()){var gX=e.getViewportLeft();
var gW=e.getViewportTop();
var gY=qx.bom.element.Location.getLeft(this.__xw)+gX;
var ha=qx.bom.element.Location.getTop(this.__xw)+gW;
var gV={x:gY,y:ha,relX:gX,relY:gW,target:e.getTarget()};
e.preventDefault();
e.stopPropagation();
qx.event.Timer.once(function(){this.fireDataEvent(dW,gV);
},this,0);
}},isLoaded:function(){return this.__xz;
},insertHtml:function(hb){return this.__xq.execute(ck,hb);
},removeFormat:function(){return this.__xq.execute(dA);
},setBold:function(){return this.__xq.execute(dx);
},setItalic:function(){return this.__xq.execute(ed);
},setUnderline:function(){return this.__xq.execute(eb);
},setStrikeThrough:function(){return this.__xq.execute(cj);
},setFontSize:function(hc){return this.__xq.execute(en,hc);
},setFontFamily:function(hd){return this.__xq.execute(X,hd);
},setTextColor:function(he){return this.__xq.execute(be,he);
},setTextBackgroundColor:function(hf){return this.__xq.execute(bH,hf);
},setJustifyLeft:function(){return this.__xq.execute(k);
},setJustifyCenter:function(){return this.__xq.execute(cf);
},setJustifyRight:function(){return this.__xq.execute(cN);
},setJustifyFull:function(){return this.__xq.execute(cy);
},insertIndent:function(){return this.__xq.execute(bY);
},insertOutdent:function(){return this.__xq.execute(db);
},insertOrderedList:function(){return this.__xq.execute(eo);
},insertUnorderedList:function(){return this.__xq.execute(cX);
},insertHorizontalRuler:function(){return this.__xq.execute(dh);
},insertImage:function(hg){return this.__xq.execute(dk,hg);
},insertHyperLink:function(hh){return this.__xq.execute(bi,hh);
},removeBackgroundColor:function(){this.__xq.execute(ef,cH);
},setBackgroundColor:function(hi){this.__xq.execute(ef,hi);
},removeBackgroundImage:function(){this.__xq.execute(o);
},setBackgroundImage:function(hj,hk,hl){return this.__xq.execute(o,[hj,hk,hl]);
},selectAll:function(){return this.__xq.execute(bl);
},undo:function(){if(this.getUseUndoRedo()){return this.__xq.execute(eA);
}else{return true;
}},redo:function(){if(this.getUseUndoRedo()){return this.__xq.execute(ds);
}else{return true;
...
}return qx.bom.htmlarea.HtmlArea.__xt(hq.body,false,hp,this.getPostProcess());
...
this.__yf();
}}),__yf:function(){if(!this.__yg()){this.__yh();
}},__yg:qx.core.Variant.select(dV,{"gecko":function(){var hy=this.getContentBody().childNodes;
...
}}}),__yh:qx.core.Variant.select(dV,{"gecko|webkit":function(){this.getContentDocument().body.innerHTML=this.__xM(dU);
...
}}}),getContextInformation:function(){return this.__yj();
},__yi:function(){qx.event.Timer.once(function(e){var hD=this.__yj();
this.fireDataEvent(bR,hD);
},this,200);
},__yj:function(){if(this._processingExamineCursorContext||this.getEditable()==false){return;
}this._processingExamineCursorContext=true;

if(!this.__yg()){this.__yh();
...
hG=hU.textAlign==cp;
hR=hU.textAlign==ew;
}else{hE=hU.getPropertyValue(ei)==ed;
...
}else{hO=hU.getPropertyValue(E)==dx||qx.dom.Node.isNodeName(hH,dY);
}}var hF=hH;
...
if(hW==null||hW==dU){hW=qx.bom.element.Attribute.get(hF,z);
}hF=hF.parentNode;
...
}}),getSelectedHtml:function(){if(this.__xE!=null){return this.__xE;
}var hX=this.getRange();

if(!hX){return dU;
}else{return this.__yk(hX);
}},__yk:qx.core.Variant.select(dV,{"mshtml":function(hY){if(!hY){return dU;
...
}}}),__yl:qx.core.Variant.select(dV,{"gecko":function(){var ih=this.getSelection();
var ii=this.getFocusNode();
return ih&&this.isSelectionCollapsed()&&ii!=null&&qx.dom.Node.isText(ii)&&ih.anchorOffset<ii.length;
},"default":function(){return false;
}}),__ym:qx.core.Variant.select(dV,{"gecko":function(){return qx.dom.Node.isElement(this.getFocusNode());
},"default":function(){return false;
}}),getRange:function(){return this.__yn(this.getSelection());
},__yn:qx.core.Variant.select(dV,{"mshtml":function(ij){var ik=this._getIframeDocument();
...
}}}),saveRange:qx.core.Variant.select(dV,{"mshtml":function(){this.__xH=this.getRange();
},"default":function(){}}),getSavedRange:qx.core.Variant.select(dV,{"mshtml":function(){return this.__xH;
},"default":function(){}}),resetSavedRange:qx.core.Variant.select(dV,{"mshtml":function(){this.__xH=null;
},"default":function(){}}),getFocusNode:qx.core.Variant.select(dV,{"mshtml":function(){var iq=this.getSelection();
var ir;

switch(iq.type){case cW:case bo:ir=this.__yn(iq);

if(ir){ir.collapse(false);
return ir.parentElement();
}else{return null;
}break;
case c:ir=this.__yn(iq);
...
}})},settings:{"qx.bom.htmlarea.HtmlArea.debug":cI},destruct:function(){try{var iv=this._getIframeDocument();
...
if(qx.core.Variant.isSet(dV,dT)){qx.bom.Iframe.setSource(this.__xF,K);
}}catch(iy){}this._disposeObjects(cP);
this.__xG=this.__xF=this.__xw=this.__xC=null;
}});
})();
...
(function(){var cw="qx.client",cv="",cu="legacy-font-size",ct="mshtml",cs="inserthtml",cr="span",cq='color',cp="text-decoration",co=';',cn="p",bx="__yF",bw="textDecoration",bv="transparent",bu="underline",bt="id",bs="InsertHtml",br='">',bq="child",bp="gecko",bo="font-family",cD="text-align",cE='text-decoration',cB="BackColor",cC="FontSize",cz="/>",cA="<img ",cx="</font>",cy="backgroundPosition",cF=':',cG='|',bV="font-size",bU="string",bX="background-color",bW="backgroundRepeat",ca="font",bY=":",cc="='",cb="__yG",bT="none",bS=" ",a=";",b="body",c="px",d="backgroundImage",f="Control",g="__paragraph__",h="qx.bom.htmlarea.HtmlArea.debug",m="on",n="size",o="' ",cS="line-through",cR="BODY",cQ="undefined",cP="backgroundColor",cW="_moz",cV="formatBlock",cU="insertParagraph",cT="li",cY='<span style="',cX="no-repeat",N=' <a href="',O="FONT",L="url(",M="|top|bottom|center|left|right|right top|left top|left bottom|right bottom|",R="__placeholder__",S='font-family:',P="outdent",Q='</a> ',J="InsertImage",K="__yI",w="__resetHtml",v="FontName",y="bold",x="blockquote",s="style",r="__yY",u="qx.bom.htmlarea.manager.Command",t="'><br class='webkit-block-placeholder' />",q="a",p='"',X="<span></span>",Y="__zd",ba="type",bb="CreateLink",T="__yX",U="italic",V='" ',W="qx_link",bc='"></span>',bd="Italic",G="fontStyle",F="InsertUnorderedList",E="OL",D='text-align:',C="Bold",B="ForeColor",A="webkit",z="__yW",I="repeat repeat-x repeat-y no-repeat",H='</p>',be="<hr />",bf="__zc",bg='<font style="',bh="IMG",bi='<p id="',bj="JustifyRight",bk="LI",bl="__getHtml",bm='>',bn="__ze",bB="__yV",bA='" size="',bz="Indent",by="top",bF="HiliteColor",bE="br",bD="fontWeight",bC="Copy",bH="</span>",bG="Paste",bO="Cut",bP="RemoveFormat",bM="StrikeThrough",bN="__yU",bK="__yL",bL='',bI="__yB",bJ='style="',bQ="__za",bR="JustifyCenter",cg="_moz_dirty",cf="color",ci="JustifyLeft",ch="Underline",ck="SelectAll",cj="<p style='",cm=")",cl="href",ce="__yK",cd='<span id="',cL="__yT",cM="__zf",cN="UL",cO="JustifyFull",cH="Outdent",cI="indent",cJ="selectall",cK="InsertOrderedList";
qx.Class.define(u,{extend:qx.core.Object,construct:function(da){qx.core.Object.call(this);
this.__yo=da;
this.__yp=null;
this._commands=null;
this.__yw();
this.__yq={"Bold":true,"Italic":true,"Underline":true,"StrikeThrough":true};
this.__yr=[10,12,16,18,24,32,48];
this.__ys=0;
},statics:{__yt:M,__yu:I},members:{__yp:null,__yo:null,__yv:false,__yq:null,__yr:null,__ys:null,setContentDocument:function(db){this.__yp=db;
},getCommandObject:function(dc){if(this._commands[dc]){return this._commands[dc];
}else{return null;
}},__yw:function(){this._commands={bold:{useBuiltin:false,identifier:C,method:bf},italic:{useBuiltin:false,identifier:bd,method:Y},underline:{useBuiltin:false,identifier:ch,method:bn},strikethrough:{useBuiltin:false,identifier:bM,method:cM},fontfamily:{useBuiltin:true,identifier:v,method:null},fontsize:{useBuiltin:false,identifier:cC,method:cL},textcolor:{useBuiltin:true,identifier:B,method:null},textbackgroundcolor:{useBuiltin:false,identifier:null,method:bN},backgroundcolor:{useBuiltin:false,identifier:null,method:bB},backgroundimage:{useBuiltin:false,identifier:null,method:z},justifyleft:{useBuiltin:false,identifier:ci,method:bx},justifyright:{useBuiltin:false,identifier:bj,method:bx},justifycenter:{useBuiltin:false,identifier:bR,method:bx},justifyfull:{useBuiltin:false,identifier:cO,method:bx},indent:{useBuiltin:true,identifier:bz,method:null},outdent:{useBuiltin:true,identifier:cH,method:null},copy:{useBuiltin:true,identifier:bC,method:null},cut:{useBuiltin:true,identifier:bO,method:null},paste:{useBuiltin:true,identifier:bG,method:null},insertorderedlist:{useBuiltin:false,identifier:cK,method:cb},insertunorderedlist:{useBuiltin:false,identifier:F,method:cb},inserthorizontalrule:{useBuiltin:false,identifier:bs,method:bK},insertimage:{useBuiltin:false,identifier:J,method:K},inserthyperlink:{useBuiltin:false,identifier:bb,method:ce},selectall:{useBuiltin:false,identifier:ck,method:T},selectedtext:{useBuiltin:false,identifier:null,method:r},selectedhtml:{useBuiltin:false,identifier:null,method:bQ},inserthtml:{useBuiltin:false,identifier:bs,method:bI},resethtml:{useBuiltin:false,identifier:null,method:w},gethtml:{useBuiltin:false,identifier:null,method:bl},removeformat:{useBuiltin:true,identifier:bP,method:null}};
},execute:function(dd,de){if(!this.__yo.isReady()){this.error("editor not ready! '"+dd+"':'"+de+"'");
return false;
}dd=dd.toLowerCase();
de=de!=null?de:null;
if(this._commands[dd]){var df;
var dg=this._commands[dd];
if(!(qx.bom.client.Engine.WEBKIT&&(dd==cI||dd==P))){if(this.__yx()){this.__yy();
}}if(dg.useBuiltin){df=this.__yz(dg.identifier,false,de);
...
}}this.__yo.resetSavedRange();
return df;
}else{this.error("Command "+dd+" is currently not supported!");
}},__yx:function(){var Node=qx.dom.Node;
var dh=this.__yo.getFocusNode();
var dk=false;
var di=false;
...
break;
}}}else if(Node.isNodeName(dh,b)){di=true;
}}return di||!dk;
},__yy:function(){this.__yz(cV,false,cn);
},__yz:function(dl,dm,dn){try{var dr=this.__yp;
var dp=false;
var dq=this.__yo.getRange();
this.__yp.body.focus();
if(qx.core.Variant.isSet(cw,ct)){if(dl!=cJ){dq.select();
if(((dq.text)&&(dq.text.length>0))||((dq.length==1)&&(dq.item(0))&&(dq.item(0).tagName==bh))){dr=dq;
}else{dr=this.__yp;
}}if((qx.core.Variant.isSet(cw,ct))&&(this.__yq[dl])){if(dq.text==cv){dp=true;
...
},__yA:qx.core.Variant.select(cw,{"mshtml":function(){var dv=this.__yo;
var du=dv.getSavedRange()!=null?dv.getSavedRange():dv.getRange();
return du;
},"default":function(){return this.__yo.getRange();
}}),__yB:qx.core.Variant.select(cw,{"mshtml":function(dw,dx){var dA;
if(dw==qx.bom.htmlarea.HtmlArea.simpleLinebreak){return this.__yE();
}else{this.__yp.body.focus();
var dz=this.__yo.getSelection();
var dy=this.__yA();
if(dy&&dz&&dz.type!=f){try{dy.pasteHTML(dw);
dy.collapse(false);
dy.select();
dA=true;
...
return dA;
}},"default":function(dB,dC){this.__yp.body.focus();
return this.__yp.execCommand(dC.identifier,false,dB);
}}),insertParagraphOnLinebreak:qx.core.Variant.select(cw,{"gecko":function(){var dK=this.__yO();
var dO=this.__yC(dK);
var dG=this.__yM(dK);
var dL=R+Date.parse(new Date());
var dM=g+Date.parse(new Date());
var dE=bL;
var dI=cd+dL+bc;
dE+=dI;
dE+=bi+dM+V+dO+bm;
dE+=dG+H;
this.__yo.getCommandManager().addUndoStep(cs,cU,this.getCommandObject(cs));
this.execute(cs,dE);
this.__yD();
qx.bom.element.Attribute.reset(this.__yp.getElementById(dL),bt);
var dJ=this.__yp.getElementById(dM);

if(dJ.previousSibling.innerHTML==dI){var dD=this.__yN();
var dH=this.__yp.createElement(bE);
var dF=this.__yp.createAttribute(cg);
dF.nodeValue=cv;
dH.setAttributeNode(dF);
var dN=this.__yp.createAttribute(ba);
dN.nodeValue=cW;
...
for(var dR in dP){if(dS[dR]){dQ+=dR+bY+dP[dR]+a;
}}this.__yo.insertHtml(cj+dQ+t);
},"default":qx.lang.Function.empty}),__yC:qx.core.Variant.select(cw,{"gecko":function(dT){var dY=bJ;
var dX=dT.child;
if(dX[cD]){dY+=D+dX[cD]+co;
delete dT.child[cD];
}if(dX[bo]){dY+=S+dX[bo]+co;
delete dT.child[bo];
...
for(var dV in dX){if(dW[dV]||dU[dV]){dY+=dV+cF+dX[dV]+co;
delete dT.child[dV];
}}dY+=p;
return dY;
},"default":function(){return cv;
}}),__yD:qx.core.Variant.select(cw,{"gecko":function(){var eh=this.__yo.getSelection();
...
if(qx.lang.String.startsWith(ee,g)&&ee==ei){var eg=ef.nextSibling;
var ec=this.__yo.getRange();
ec.selectNode(eg);
eh.addRange(ec);
var eb=qx.bom.htmlarea.HtmlArea.EMPTY_DIV;
this.__yo.getCommandManager().addUndoStep(cs,eb,this.getCommandObject(cs));
this.execute(cs,eb);
var ed=this.__yo.getRange();

if(ea){while(ea&&ea.firstChild&&qx.dom.Node.isElement(ea.firstChild)){ea=ea.firstChild;
}}ed.selectNode(ea);
eh.addRange(ed);
ed.collapse(true);
}},"default":qx.lang.Function.empty}),__yE:qx.core.Variant.select(cw,{"mshtml":function(){var ej=this.__yo.getRange();
...
}}),__yF:function(ek,el){var em=qx.core.Variant.isSet(cw,ct)?this.__yo.getRange():this.__yp;
return em.execCommand(el.identifier,false,ek);
},__yG:function(en,eo){if(qx.core.Variant.isSet(cw,ct)){var ep=this.__yo.getFocusNode();
this.__yH(ep);
}this.__yp.body.focus();
var eq=this.__yp.execCommand(eo.identifier,false,en);

if(qx.core.Variant.isSet(cw,A)){var ep=this.__yo.getFocusNode();
this.__yH(ep.parentNode);
}return eq;
},__yH:function(er){var es=[];
var parent=er.parentNode;

while(qx.dom.Node.isNodeName(parent,x)){es.push(parent);
parent=parent.parentNode;
}if(es.length>0){parent.appendChild(er);
parent.removeChild(es[es.length-1]);
}},__yI:qx.core.Variant.select(cw,{"gecko":function(et,eu){if(et.src){this.__yp.execCommand(eu.identifier,false,et.src);
delete et.src;
var eI=this.__yo.getSelection();
if(eI){var eH=eI.anchorNode;
var eC=eI.anchorOffset;
var ez=eH.childNodes[eC-1];
var eF;

for(var eB in et){eF=this.__yp.createAttribute(eB);
eF.nodeValue=et[eB];
...
eE=false;
}var ey=this.__yp.createDocumentFragment();
var eJ;

if(eE&&ew!=null){var eA=this.__yJ(ew);
ey.appendChild(eA.root);
eJ=eA.inline;
}else{eJ=this.__yp.createElement(cr);
ey.appendChild(eJ);
}var eG=this.__yp.createTextNode(cv);
eJ.appendChild(eG);
var eD=ez.parentNode;
if(ez==eD.lastChild){eD.appendChild(ey);
}else{eD.insertBefore(ey,ez.nextSibling);
}var ev=this.__yo.getRange();
...
var eN=this.__yo.getSelection();
var eO=this.__yA();
if(eN&&eN.type!=f){try{eO.select();
eO.pasteHTML(eQ);
eP=true;
}catch(e){}}this.__yo.resetSavedRange();
return eP;
},"default":function(eR,eS){if(eR.src){var eU=cA;

for(var eT in eR){eU+=eT+cc+eR[eT]+o;
}eU+=cz;
return this.__yp.execCommand(bs,false,eU);
}else{return false;
}}}),__yJ:function(eV){while(eV.firstChild&&eV.firstChild.nodeType==1){eV=eV.firstChild;
}var fa=this.__yO(eV);
var fe,eX,fc;
var eW=cv;
var parent=null;
...
while(fb){fd=this.__yp.createElement(fb[cu]?ca:cr);
eX=this.__yp.createAttribute(s);
fd.setAttributeNode(eX);
for(var eY in fb){if(eY!=bq&&eY!=cu){eW+=eY+bY+fb[eY]+a;
}else if(eY==cu){fc=this.__yp.createAttribute(n);
fc.nodeValue=fb[eY];
...
},__yK:qx.core.Variant.select(cw,{"gecko|opera":function(ff,fg){var fm=this.__yo.getSelection();
var fj=this.__yo.getRange();
if(fm.isCollapsed){var fi=W+(++this.__ys);
var fn=this.__yp.createElement(q);
var fk=this.__yp.createAttribute(cl);
var fh=this.__yp.createAttribute(bt);
var fl=this.__yp.createTextNode(ff);
fh.nodeValue=fi;
...
fm.collapseToEnd();
return true;
}else{return this.__yp.execCommand(fg.identifier,false,ff);
...
}else{fr=this.__yB(N+fo+br+fo+Q,fp);
}this.__yo.resetSavedRange();
return fr;
}catch(e){{};
return false;
}},"default":function(ft,fu){return this.__yp.execCommand(fu.identifier,false,ft);
}}),__yL:function(fv,fw){var fx=be;
if(qx.core.Variant.isSet(cw,bp)){fx+=this.__yM();
}return this.__yB(fx,fw);
},__yM:function(fy){var fC=cv;
var fB=cY;
var fA=[];
var fF=typeof fy!==cQ?fy:this.__yO();
var fD=fF.child;
var fE=false;
...
for(var fz in fD){fC+=(fz!=bq&&fz!=cu)?fz+cF+fD[fz]+co:cv;
}fC+=fE?bA+fD[cu]+br:br;
fA.unshift(fE?cx:bH);
fD=fD.child;
}if(fA.length==1&&fA[0]==cx){fC+=X;
}for(var i=0,j=fA.length;i<j;i++){fC+=fA[i];
}return fC;
},__yN:function(){var fH=this.__yp.createDocumentFragment();
var fM=this.__yO();
var parent=fH;
var fK=fM.child;
var fI;
...
},getCurrentStyles:function(fT){if(fT==null){var fV=this.__yo.getSelection();
...
var fU=this.__yP(fY);
var fX=this.__yQ(fU,fY);
return fX;
},__yP:function(ga){var gd={};
var gb,gc;
...
}}if(gd[cu]&&gd[bV]){delete gd[bV];
}return gd;
},__yQ:function(ge,gf){var gk=gf[0];
var gi=this.__yo.getContentWindow().getComputedStyle(gk,null);
var gg;
var gj={};

for(var gh in ge){if(gh!=cu){gg=gi.getPropertyValue(gh);
}else{gg=ge[gh];
}if(gh==bX&&gg==bv){gj[gh]=this.__yS(gf);
}else if(gh==cp){gj[gh]=this.__yR(gf);
}else{gj[gh]=gg;
}}return gj;
},__yR:function(gl){var go,gq,gm;
var gp=[];
var gn=this.__yo.getContentWindow();

for(var i=0,j=gl.length;i<j;i++){gm=gn.getComputedStyle(gl[i],null);
go=gm.getPropertyValue(cp);
gq=gm.getPropertyValue(cf);
if(go!=bT){gp.push({'text-decoration':go,'color':gq});
}}return gp;
},__yS:function(gr){var gt,gs,gu;

for(var i=0;i<gr.length;i++){gt=gr[i];
gs=this.__yo.getContentWindow().getComputedStyle(gt,null);
gu=gs.getPropertyValue(bX);
if(gu!=bv){return gu;
}}},__yT:function(gv,gw){var gI=this.__yo.getSelection();
var gD=(qx.core.Variant.isSet(cw,ct))?this.__yo.getRange():gD=gI.getRangeAt(0);
var gE=[];
var gH;
var gC=[E,cN];
var gx,i,j,gF;
...
(gI.containsNode(gB,false))){gB.style.fontSize=(this.__yr[gv]||gv)+c;
}}}}else{var gA=(qx.core.Variant.isSet(cw,ct))?gF:gI.focusNode;
var gG=qx.dom.Hierarchy.getAncestors(gA);

for(i=0;i<gG.length;i++){if(gG[i].tagName==bk){if(((qx.core.Variant.isSet(cw,bp))&&
((gI.anchorOffset==0)&&
...
((qx.core.Variant.isSet(cw,ct))&&(gD.htmlText==gG[i].innerHTML))){gG[i].style.fontSize=(this.__yr[gv]||gv)+c;
}break;
}}}if(qx.core.Variant.isSet(cw,ct)){this.__yp.body.focus();
this.__yo.getRange().select();
return this.__yp.execCommand(cC,false,gv);
...
},__yU:qx.core.Variant.select(cw,{"mshtml":function(gJ,gK){this.__yp.body.focus();
return this.__yp.execCommand(cB,false,gJ);
},"gecko|opera":function(gL,gM){this.__yp.body.focus();
return this.__yp.execCommand(bF,false,gL);
},"webkit":function(gN,gO){var gP=this.__yo.getSelection();
var gQ=this.__yo.getRange();
if(!gP||!gP.isCollapsed){this.__yp.body.focus();
this.__yp.execCommand(cB,false,gN);
...
}}gQ.setStart(gP.anchorNode,gP.anchorNode.nodeValue.charAt(gT)==bS?gT+1:gT);
...
gP.collapseToEnd();
return true;
}}}),__yV:function(gU,gV){gU=gU!=null&&typeof gU==bU?gU:bv;
qx.bom.element.Style.set(this.__yp.body,cP,gU);
return true;
},__yW:function(gW,gX){var gY,hb,ha;
...
hb=gW[1];
ha=gW[2];
}if(gY==null||typeof gY!=bU){qx.bom.element.Style.set(this.__yp.body,d,cv);
qx.bom.element.Style.set(this.__yp.body,bW,cv);
qx.bom.element.Style.set(this.__yp.body,cy,cv);
return true;
}else{if(gY.search(/^url.*\(/)==-1){gY=L+gY+cm;
}}if(hb!=null&&!qx.lang.String.contains(hc.__yu,hb)){{};
return false;
}else{hb=cX;
}
if(ha!=null){if(qx.lang.Type.isString(ha)&&!qx.lang.String.contains(hc.__yt,cG+ha+cG)){{};
return false;
}else{if(qx.lang.Type.isArray(ha)&&ha.length==2){ha=ha[0]+bS+ha[1];
}else{{};
return false;
}}}else{ha=by;
}qx.bom.element.Style.set(this.__yp.body,d,gY);
qx.bom.element.Style.set(this.__yp.body,bW,hb);
qx.bom.element.Style.set(this.__yp.body,cy,ha);
return true;
},__yX:qx.core.Variant.select(cw,{"mshtml":function(hd,he){var hf=this.__yp.body.createTextRange();
hf.select();
return true;
},"default":function(hg,hh){return this.__yz(hh.identifier,false,hg);
}}),__yY:function(){return this.__yo.getSelectedText();
},__za:function(){return this.__yo.getSelectedHtml();
},__zb:function(hi,hj){var hn=this.__yo.getFocusNode();
...
while(hl.length>0){if(Node.getName(hm)==cn||Node.getName(hm)==b){break;
}if(hk.get(hm,hi,hk.LOCAL_MODE)==hj){hk.reset(hm,hi);
return true;
}hm=hl.shift();
}}return false;
},__zc:qx.core.Variant.select(cw,{"gecko":function(ho,hp){if(this.__zb(bD,y)){return true;
}else{return this.__yz(hp.identifier,false,ho);
}},"default":function(hq,hr){return this.__yz(hr.identifier,false,hq);
}}),__zd:qx.core.Variant.select(cw,{"gecko":function(hs,ht){if(this.__zb(G,U)){return true;
}else{return this.__yz(ht.identifier,false,hs);
}},"default":function(hu,hv){return this.__yz(hv.identifier,false,hu);
}}),__ze:qx.core.Variant.select(cw,{"gecko":function(hw,hx){if(this.__zb(bw,bu)){return true;
}else{return this.__yz(hx.identifier,false,hw);
}},"webkit":function(hy,hz){var hA=this.__yo.getContextInformation();
var hC=this.__yo.getFocusNode();
if(hA.underline){hC.style.textDecoration=bT;
}else{if(hA.strikethrough){var hD=this.__yp.createElement(cr);
qx.bom.element.Style.set(hD,bw,bu);
hC.appendChild(hD);
var hB=this.__yo.getSelection();
...
},"default":function(hE,hF){return this.__yz(hF.identifier,false,hE);
}}),__zf:qx.core.Variant.select(cw,{"gecko":function(hG,hH){if(this.__zb(bw,cS)){return true;
}else{return this.__yz(hH.identifier,false,hG);
}},"webkit":function(hI,hJ){var hL=this.__yo.getFocusNode();
var hM=this.__yp.createElement(cr);
qx.bom.element.Style.set(hM,bw,cS);
hL.appendChild(hM);
var hK=this.__yo.getSelection();

if(hK){hK.extend(hM,0);

if(!hK.isCollapsed){hK.collapseToEnd();
}}return true;
},"default":function(hN,hO){return this.__yz(hO.identifier,false,hN);
}})},destruct:function(){this.__yp=this.__yo=this._commands=null;
this.__yq=this.__yr=null;
}});
})();
(function(){var m="qx.client",l="Command",k="mshtml",h="gecko",g="Custom",f="Content",d="Internal",c="inserthtml",b="backgroundimage",a="backgroundcolor",bi="webkit",bh="backgroundColor",bg="mousedown",bf="table",be="backgroundImage",bd="backgroundRepeat",bc="p",bb="backgroundPosition",ba="td",Y="img",t="inserthyperlink",u="mouseup",r="keypress",s="qx.bom.htmlarea.HtmlArea.debug",p="on",q="undo",n="undoRedoState",o="pageup",x="b",y="control",G="shift",E="end",O="right",J="qx_link",U="insertunorderedlist",S="__zg",A="Undo",X="pagedown",W="k",V="home",z="a",C="insertorderedlist",D="y",F="justifyright",H="redo",K="insertParagraph",P="qx.bom.htmlarea.manager.UndoRedo",T="left",v="i",w="Redo",B="u",N="enter",M="insertimage",L="z",R="down",Q="up",I="body";
...
this.__zk=null;
this.__zl={};
this.__zm={command:true,content:true,custom:true};
this.__zK();
this.__zn=qx.lang.Function.bind(this._handleKeyPress,this);
this.__zo=qx.lang.Function.bind(this._handleMouseUp,this);

if(qx.core.Variant.isSet(m,k)){this.__zp=qx.lang.Function.bind(this._handleMouseDown,this);
}},members:{__zq:false,__zr:false,__zs:false,__zm:null,__zl:null,__zg:null,__zk:null,__zi:null,__zj:null,__zh:null,__zn:null,__zo:null,__zp:null,__zt:null,setContentDocument:function(bl){this.__zk=bl;
this.__zg.setContentDocument(bl);
qx.event.Registration.addListener(bl.body,r,this.__zn,this);
qx.event.Registration.addListener(bl.body,u,this.__zo,this);

if(qx.core.Variant.isSet(m,k)){qx.event.Registration.addListener(bl.body,bg,this.__zp,this,true);
}},insertParagraphOnLinebreak:function(){return this.__zg.insertParagraphOnLinebreak();
},execute:function(bm,bn){var bo;
bm=bm.toLowerCase();
if(this._commands[bm]){if(this._commands[bm].passthrough){bo=this.__zg.execute(bm,bn);
}else{bo=this[bm].call(this);
}}else{if(qx.core.Variant.isSet(m,k)||qx.core.Variant.isSet(m,bi)){this.__zL(bm,bn,this.__zg.getCommandObject(bm));
bo=this.__zg.execute(bm,bn);
if(!bo){this.__zi.pop();
}}else{bo=this.__zg.execute(bm,bn);

if(bo){this.__zL(bm,bn,this.__zg.getCommandObject(bm));
}}
if(bm==q&&this.__zi.length==0){this.__zr=false;
this.__zT();
}else if(bm==H&&this.__zj.length==0){this.__zq=false;
this.__zT();
}}this.__zs=false;
return bo;
},addUndoStep:function(bp,bq,br){this.__zL(bp,bq,br);
},registerHandler:function(bs,bt,bu,bv){this.__zl[bs]={undo:bt,redo:bu,context:bv};
},isUndoPossible:function(){return this.__zr;
},undo:function(){var by;

if(this.__zs){this.__zN();
}if(this.__zi.length>0){var bx=this.__zi.pop();

if(this.__zm[bx.actionType.toLowerCase()]){switch(bx.actionType){case l:by=this.__zv(bx);
break;
case f:by=this.__zz(bx);
break;
case d:by=this.__zy(bx);
break;
case g:by=this.__zu(bx);
break;
}}else if(this.__zl[bx.actionType]){var bw=this.__zl[bx.actionType];
...
this.__zT();
return by;
}},__zu:qx.core.Variant.select(m,{"mshtml|webkit":function(bz){var bA=this.__zk.body.innerHTML;
var bC=bz.content;
this.__zk.body.innerHTML=bC;
var bB=bz;
bB.content=bA;
this.__zP(bB);
return true;
...
switch(bD.command){case a:bH.parameter=[bG.get(this.__zk.body,bh)];
break;
case b:bH.parameter=[bG.get(this.__zk.body,be),bG.get(this.__zk.body,bd),bG.get(this.__zk.body,bb)];
break;
}this.__zP(bH);
if(bD.command==t){if(qx.core.Variant.isSet(m,h)){var bF=J+this.__zg.__hyperLinkId;
var bE=this.__zk.getElementById(bF);

if(bE){bE.parentNode.removeChild(bE);
return true;
}else{return false;
}}}else{return this.__zg.execute(bD.command,bD.value);
}}}),__zv:qx.core.Variant.select(m,{"mshtml|webkit":function(bI){},"default":function(bJ){this.__zP(bJ);

if(qx.core.Variant.isSet(m,h)){if(bJ.command==c&&bJ.value==qx.bom.htmlarea.HtmlArea.EMPTY_DIV&&this.__zw(c,K)){this.__zx();
}}return this.__zA();
}}),__zw:function(bK,bL){if(this.__zi.length>0){var bM=this.__zi[this.__zi.length-1];
return (bM.command==bK&&bM.value==bL);
}return false;
},__zx:function(){this.__zA();

if(this.__zi.length>0){var bN=this.__zi.pop();
this.__zP(bN);
}},__zy:function(bO){this.__zP(bO);
return this.__zA();
},__zz:qx.core.Variant.select(m,{"gecko":function(bP){this.__zP(bP);

try{return this.__zA();
}catch(bQ){{};
}},"mshtml|webkit":function(bR){},"default":function(bS){this.__zP(bS);
return this.__zA();
}}),__zA:function(){try{return this.__zk.execCommand(A,false,null);
}catch(e){return false;
}},isRedoPossible:function(){return this.__zq;
},redo:function(){if(this.__zq){var bU;
if(this.__zj.length>0){var bV=this.__zj.pop();

if(this.__zm[bV.actionType.toLowerCase()]){switch(bV.actionType){case l:bU=this.__zC(bV);
break;
case f:bU=this.__zI(bV);
break;
case d:bU=this.__zH(bV);
break;
case g:bU=this.__zB(bV);
break;
}}else if(this.__zl[bV.actionType]){var bT=this.__zl[bV.actionType];
...
}},__zB:qx.core.Variant.select(m,{"mshtml|webkit":function(bW){var bX=this.__zk.body.innerHTML;
var ca=bW.content;
this.__zk.body.innerHTML=ca;
var bY=bW;
bY.content=bX;
this.__zO(bY);
return true;
},"default":function(cb){this.__zO(cb);
return this.__zJ();
}}),__zC:qx.core.Variant.select(m,{"mshtml|webkit":function(cc){},"default":function(cd){this.__zO(cd);
var ce=this.__zJ();

if(qx.core.Variant.isSet(m,h)){if(this.__zD(c,qx.bom.htmlarea.HtmlArea.EMPTY_DIV)){var cf=this.__zE();
this.__zF();

if(cf!=null){this.__zG(cf);
}}}return ce;
}}),__zD:function(cg,ch){if(this.__zj.length>0){var ci=this.__zj[this.__zj.length-1];
return (ci.command==cg&&ci.value==ch);
}return false;
},__zE:function(){if(this.__zh==null){return null;
}var cj=this.__zh.getSelection();
...
}},__zF:function(){var cm=this.__zj.pop();
this.__zO(cm);
this.__zJ();
},__zG:qx.core.Variant.select(m,{"gecko":function(cn){if(cn==this.__zh.getContentBody().lastChild){return;
}var cq=cn.firstChild;

while(cq.firstChild){cq=cq.firstChild;
}var co=this.__zh.getSelection();
var cp=this.__zh.getRange();

if(co&&cp){cp.selectNode(cq);
co.addRange(cp);
cp.collapse(true);
}},"default":qx.lang.Function.empty}),__zH:function(cr){this.__zO(cr);
return this.__zJ();
},__zI:qx.core.Variant.select(m,{"mshtml|webkit":function(cs){},"default":function(ct){this.__zO(ct);
return this.__zJ();
}}),__zJ:function(){try{return this.__zk.execCommand(w,false,null);
}catch(e){return false;
}},__zK:function(){this._commands={undo:{passthrough:false},redo:{passthrough:false}};
this.__zg.getCommandObject(a).customUndo=true;
this.__zg.getCommandObject(b).customUndo=true;

if(qx.core.Variant.isSet(m,h)){}},__zL:qx.core.Variant.select(m,{"mshtml|webkit":function(cu,cv,cw){var cx=this.getUndoRedoObject();
cx.commandObject=cw;
cx.command=cu;
cx.value=cv;
cx.actionType=g;
cx.content=this.__zk.body.innerHTML;
this.__zM(cx);
},"default":function(cy,cz,cA){if(this.__zh==null){return;
}var cC=this.getUndoRedoObject();
cC.commandObject=cA;
cC.command=cy;
cC.value=cz;
cC.actionType=g;
var cB=this.__zh.getSelection();

if(cA.customUndo){var cD=[];

switch(cy){case a:cD.push(qx.bom.element.Style.get(this.__zk.body,bh));
break;
case b:cD.push(qx.bom.element.Style.get(this.__zk.body,be),qx.bom.element.Style.get(this.__zk.body,bd),qx.bom.element.Style.get(this.__zk.body,bb));
break;
...
}}),__zM:function(cE){if(this.__zs){this.__zN();
}this.__zO(cE);
this.__zq=false;
this.__zj=[];
this.__zT();
},__zN:function(){var cF=this.__zi[this.__zi.length-1];

if(cF==null||cF.actionType!=f){var cG=this.getUndoRedoObject();
cG.actionType=f;

if(qx.core.Variant.isSet(m,k)||qx.core.Variant.isSet(m,bi)){cG.content=this.__zt;
cG.actionType=g;
this.__zt=null;
}this.__zO(cG);
this.__zs=false;
...
},__zO:function(cH){if(false&&qx.core.Setting.get(s)==p){this.debug("ADD TO UNDO STACK");
this.debug(cH.actionType+" "+cH.command+" "+cH.value);
}this.__zi.push(cH);
},__zP:function(cI){if(false&&qx.core.Setting.get(s)==p){this.debug("ADD TO REDO STACK");
...
case z:case x:case v:case B:case W:case D:case L:if(!cK){this.__zQ();
}break;
default:this.__zq=false;
this.__zj=[];
this.__zQ();
}},__zQ:function(){if(!this.__zs){this.__zs=true;
this.__zr=true;
if(qx.core.Variant.isSet(m,k)||qx.core.Variant.isSet(m,bi)){this.__zt=this.__zk.body.innerHTML;
}this.__zT();
}},__zR:null,_handleMouseDown:qx.core.Variant.select(m,{"mshtml":function(e){var cL=e.getOriginalTarget();

if(qx.dom.Node.isElement(cL)&&(qx.dom.Node.isNodeName(cL,Y)||qx.dom.Node.isNodeName(cL,bf))){this.__zR={node:cL,content:cL.outerHTML};
}else{this.__zR=null;
}},"default":function(e){return true;
}}),_handleMouseUp:qx.core.Variant.select(m,{"gecko":function(e){if(this.__zh==null){return;
}var cN=this.__zh.getSelection();

if(!cN){this.__zR=null;
return;
}var cM=cN.anchorNode;
var cO=cM.childNodes[cN.anchorOffset];
if(qx.dom.Node.isNodeName(cO,Y)){if(this.__zR==null){this.__zR=cO.cloneNode(true);
}else{if(this.__zR.style.width!=cO.style.width||this.__zR.style.height!=cO.style.height){this.__zS();
this.__zR=cO.cloneNode(true);
...
}if(this.__zR==null){this.__zR=cP.cloneNode(true);
}else{qx.event.Timer.once(function(){if(cP.style.width!=this.__zR.style.width||cP.style.height!=this.__zR.style.height||cP.innerHTML!=this.__zR.innerHTML){this.__zS();
this.__zR=cP.cloneNode(true);
}},this,0);
}}else{this.__zR=null;
}},"default":function(e){var cQ=qx.bom.Event.getTarget(e);

if(this.__zR!=null){if(cQ.nodeType==1){if(cQ==this.__zR.node){if(cQ.outerHTML!=this.__zR.content){this.__zR.content=cQ.outerHTML;
this.__zS();
}}else{for(var i=0,j=cQ.childNodes.length;i<j;i++){if(cQ.childNodes[i]==this.__zR.node){if(cQ.childNodes[i].outerHTML!=this.__zR.content){this.__zR.content=cQ.childNodes[i].outerHTML;
this.__zS();
}}}}}else{this.__zR=null;
}}}}),__zS:qx.core.Variant.select(m,{"mshtml|webkit":function(){this.__zL(d,null,null);
},"default":function(){var cR=this.getUndoRedoObject();
cR.actionType=d;
this.__zO(cR);
}}),__zT:function(){qx.event.Timer.once(function(e){if(this.__zh!=null){var cS={undo:this.isUndoPossible()?0:-1,redo:this.isRedoPossible()?0:-1};
this.__zh.fireDataEvent(n,cS);
}},this,200);
}},destruct:function(){try{qx.event.Registration.removeListener(this.__zk.body,r,this.__zn);
qx.event.Registration.removeListener(this.__zk,u,this.__zo);

if(qx.core.Variant.isSet(m,k)){qx.event.Registration.removeListener(this.__zk,bg,this.__zp);
}}catch(e){}this._disposeObjects(S);
this.__zh=this.__zi=this.__zj=this._commands=this.__zk=null;
this.__zm=this.__zl=null;
}});
})();
...
qx.Class.define(e,{statics:{__nx:{text:1,textarea:1,select:1,checkbox:1,radio:1,password:1,hidden:1,submit:1,image:1,file:1,search:1,reset:1,button:1},create:function(w,x,y){{};
...
if(bf&&bf.nodeType){return this.__vH([bf]);
}else{return bf;
}}return null;
};
};
...
},__vD:/^[^<]*(<(.|\s)+>)[^>]*$|^#([\w-]+)$/,create:function(bo,bp){var br=qx.bom.Collection;
if(bo.nodeType){return new br(bo);
}else if(typeof bo===I){var bq=br.__vD.exec(bo);
...
},__vF:/^.[^:#\[\.,]*$/,not:function(bH){if(this.__vF.test(bH)){var bI=qx.bom.Selector.matches(g+bH+d,this);
return this.__vH(bI);
...
return this.__vH(qx.lang.Array.unique(bS));
...
if(this.length===1){return this.__vH(ca.query(bX,this[0]));
}else{var bY=[];

for(var i=0,l=this.length;i<l;i++){bY.push.apply(bY,ca.query(bX,this[i]));
}return this.__vH(qx.lang.Array.unique(bY));
...
},nextAll:function(ce){return this.__vG(y,ce);
...
},prevAll:function(ci){return this.__vG(c,ci);
...
},parents:function(cl){return this.__vG(H,cl);
},siblings:function(cm){return this.__vG(s,cm);
},__vG:function(cn,co){var cq=[];
...
},__vH:function(cs){var ct=new qx.bom.Collection;
ct.__vE=this;
cs=Array.prototype.slice.call(cs,0);
ct.push.apply(ct,cs);
return ct;
},andSelf:function(){return this.add(this.__vE);
},end:function(){return this.__vE||new qx.bom.Collection();
},__vI:function(cu,cv){var cA=this[0];
...
},__vJ:function(cF,cG){var cI=qx.bom.Selector;
...
},append:function(cL){return this.__vI(arguments,this.__vK);
},prepend:function(cM){return this.__vI(arguments,this.__vL);
},__vK:function(cN,cO){cN.appendChild(cO);
},__vL:function(cP,cQ){cP.insertBefore(cQ,cP.firstChild);
},appendTo:function(cR){return this.__vJ(arguments,e);
},prependTo:function(cS){return this.__vJ(arguments,J);
},before:function(cT){return this.__vI(arguments,this.__vM);
},after:function(cU){return this.__vI(arguments,this.__vN);
},__vM:function(cV,cW){cV.parentNode.insertBefore(cW,cV);
},__vN:function(cX,cY){cX.parentNode.insertBefore(cY,cX.nextSibling);
},insertBefore:function(da){return this.__vJ(arguments,w);
},insertAfter:function(db){return this.__vJ(arguments,q);
...
}dc.map(this.__vO).append(this);
}return this;
},__vO:function(de){while(de.firstChild){de=de.firstChild;
}return de;
...
},replaceAll:function(dh){return this.__vJ(arguments,n);
...
qx.Class.define(n,{statics:{__vP:function(K,L,M){return M.match(/^(abbr|br|col|img|input|link|meta|param|hr|area|embed)$/i)?K:L+z+M+H;
},__vQ:{opt:[1,e,c],leg:[1,f,u],table:[1,g,y],tr:[2,r,E],td:[3,I,b],col:[2,G,C],def:qx.core.Variant.select(m,{"mshtml":[1,s,d],"default":null})},__vR:function(N,O){var U=O.createElement(J);
N=N.replace(/(<(\w+)[^>]*?)\/>/g,this.__vP);
...
if(typeof ba===k){ba=this.__vR(ba,X);
...
qx.Bootstrap.define(f,{construct:function(){this.__vS=qx.Bootstrap.bind(this.__vY,this);
this.__vT=document.createElement(d);
},members:{__vU:null,__vV:null,__vW:null,__vX:null,__vS:null,__vT:null,load:function(p,q,r){if(this.__vU){throw new Error("Another request is still running!");
}this.__vU=true;
this.__vV=false;
...
this.__vX=r||window;
t.type=c;
t.onerror=t.onload=t.onreadystatechange=this.__vS;
t.src=p;
setTimeout(function(){s.appendChild(t);
},0);
},abort:function(){if(this.__vU){this.dispose(a);
}},dispose:function(status){if(this.__vV){return;
}this.__vV=true;
var v=this.__vT;
...
if(this.__vW){if(qx.core.Variant.isSet(j,b)){var self=this;
setTimeout(qx.event.GlobalError.observeMethod(function(){self.__vW.call(self.__vX,status);
delete self.__vW;
}),0);
}else{this.__vW.call(this.__vX,status);
delete this.__vW;
}}},__vY:qx.event.GlobalError.observeMethod(qx.core.Variant.select(j,{"mshtml":function(e){var w=this.__vT.readyState;
...
}},properties:{backgroundColor:{check:b,nullable:true,apply:c}},members:{__mz:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
