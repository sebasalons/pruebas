...
(function(){var j="Integer",i="resize",h="_applyCanvasWidth",g="redraw",f="Boolean",d="__Aq",c="_applyCanvasHeight",b="qx.ui.embed.Canvas",a="qx.event.type.Data";
qx.Class.define(b,{extend:qx.ui.core.Widget,construct:function(k,l){qx.ui.core.Widget.call(this);
this.__Aq=new qx.util.DeferredCall(this.__Ar,this);
this.addListener(i,this._onResize,this);

if(k!==undefined){this.setCanvasWidth(k);
}
if(l!==undefined){this.setCanvasHeight(l);
}},events:{"redraw":a},properties:{syncDimension:{check:f,init:false},canvasWidth:{check:j,init:300,apply:h},canvasHeight:{check:j,init:150,apply:c}},members:{__Aq:null,_createContentElement:function(){return new qx.html.Canvas();
},__Ar:function(){var n=this.getContentElement();
var p=n.getHeight();
var m=n.getWidth();
...
this.__Aq.schedule();
},update:function(){this.__Aq.schedule();
...
this.__As=document.createElement(c);
},members:{__As:null,_createDomElement:function(){return this.__As;
},getCanvas:function(){return this.__As;
},setWidth:function(f){this.__As.width=f;
},getWidth:function(){return this.__As.width;
},setHeight:function(g){this.__As.height=g;
},getHeight:function(){return this.__As.height;
},getContext2d:function(){return this.__As.getContext(b);
