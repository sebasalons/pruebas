...
var settings = {"qx.allowUrlSettings":"true","qx.allowUrlVariants":"true","qx.application":"demobrowser.demo.widget.ProgressBar","qx.theme":"qx.theme.Modern"};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:demobrowser.demo.widget.ProgressBar-qx.theme.Modern.js"]],
  urisBefore : [],
  packageHashes : {"0":"21b129da51c2"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
}},properties:{appearance:{refine:true,init:f}},events:{complete:c,change:a},members:{__Ax:0,__Ay:100,getValue:function(){return this.__Ax;
...
this.__Az(l/m);
return l;
},getMaximum:function(){return this.__Ay;
...
},__Az:function(t){var v=this.getChildControl(i);
