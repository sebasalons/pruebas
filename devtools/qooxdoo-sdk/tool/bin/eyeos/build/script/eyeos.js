...
var settings = {"qx.application":"eyeos.Application","qx.theme":"eyeos.theme.Theme","qx.version":"1.3"};
...
var libinfo = {"__out__":{"sourceUri":"script"},"eyeos":{"resourceUri":"resource","sourceUri":"script","version":"trunk"},"qx":{"resourceUri":"resource","sourceUri":"script","version":"1.3"}};
...
qx.$$loader = {
  parts : {"boot":[0]},
  uris : [["__out__:eyeos.js"]],
  urisBefore : [],
  packageHashes : {"0":"7e114ee23dd9"},
  boot : "boot",
  closureParts : {},
  bootIsInline : true,
...
(function(){var g="a\nb\nc",f="eyeos/test.png",d='Esto es una prueba',c="First Button",b="eyeos.Application",a="execute";
...
{};
var i=new qx.ui.form.Button(c,f);
var h=this.getRoot();
h.add(i,{left:100,top:50});
var k=new qx.ui.basic.Label(d);
h.add(k);
var j=new qx.ui.form.TextArea(g).set({maxLength:5});
h.add(j);
i.addListener(a,function(e){console.log(j.getValue().length);
});
}}});
})();
...
qx.Class.define(v,{statics:{DEBUG_ON:false,__cI:{},bind:function(E,F,G,H,I){var S=this.__cK(E,F,G,H,I);
var N=F.split(d);
var K=this.__cQ(N);
var R=[];
var O=[];
...
(function(){var j="div",i="inherit",h="text",g="qx.client",f="value",e="",d="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul",c="nowrap",b="auto",a="0",z="ellipsis",y="normal",x="label",w="hidden",v="px",u="crop",t="gecko",s="end",r="100%",q="visible",o="qx.bom.Label",p="opera",m="mshtml",n="block",k="-1000px",l="absolute";
...
if(!qx.bom.client.Feature.CSS_TEXT_OVERFLOW&&qx.bom.client.Feature.XUL){var F=document.createElementNS(d,x);
var E=F.style;
E.padding=a;
...
I.textOverflow=z;
if(qx.core.Variant.isSet(g,p)){I.OTextOverflow=z;
}}return I;
...
var N=K.document.createElementNS(d,x);
var M=N.style;
M.cursor=i;
M.color=i;
M.overflow=w;
...
U.style.width=T!==undefined?T+v:b;
U.innerHTML=content;
...
qx.Mixin.define(d,{construct:function(){if(qx.core.Variant.isSet(m,i)){qx.locale.Manager.getInstance().addListener(k,this.__lh,this);
...
},__lh:qx.core.Variant.select(m,{"on":function(e){var p=this.getInvalidMessage();
...
}},"off":null})},destruct:function(){if(qx.core.Variant.isSet(m,i)){qx.locale.Manager.getInstance().removeListener(k,this.__lh,this);
}}});
})();
...
if(bi&&this.__li){this.__lp().setStyles({"left":bj.left+bn,"top":bj.top+bn});
}
if(bk){if(this.__li){this.__lp().setStyles({"width":innerWidth+bn,"height":innerHeight+bn});
...
if(this.__li){if(bq){this._showPlaceholder();
...
if(this.__li){this.__lp().setStyles(bv);
}if(bt){this.__ln=qx.bom.Label.getTextSize(l,bv);
...
}if(bB){this.fireDataEvent(bc,bC,this.__lm);
this.__lm=bC;
if(this.getLiveUpdate()){this.__lo(bC);
}}},__lo:function(bE){var bF=this.__ll;
this.__ll=bE;

if(bF!=bE){this.fireNonBubblingEvent(o,qx.event.type.Data,[bE,bF]);
}},setValue:function(bG){if(bG===null){if(this.__lj){return bG;
}bG=j;
this.__lj=true;
}else{this.__lj=false;
if(this.__li){this._removePlaceholder();
}}
...
}}},_removePlaceholder:function(){if(this.hasState(k)){this.__lp().setStyle(ba,W);
this.removeState(k);
}},_syncPlaceholder:function(){if(this.hasState(k)){this.__lp().setStyle(ba,C);
}},__lp:function(){if(this.__lk==null){this.__lk=new qx.html.Label();
var bP=qx.theme.manager.Color.getInstance();
this.__lk.setStyles({"visibility":W,"zIndex":6,"position":U,"color":bP.resolve(J)});
...
}},"off":null}),_applyPlaceholder:function(bQ,bR){if(this.__li){this.__lp().setValue(bQ);
...
}},setEnabled:qx.core.Variant.select(g,{"webkit":function(r){this.__ls=r;

if(!r){this.setStyles({"userModify":a,"userSelect":h});
}else{this.setStyles({"userModify":null,"userSelect":this.__lr?null:h});
}},"default":function(s){this.setAttribute(b,s===false);
}}),setSelectable:qx.core.Variant.select(g,{"webkit":function(t){this.__lr=t;
qx.html.Element.prototype.setSelectable.call(this,this.__ls&&t);
...
},setWrap:function(y){if(this.__lq===i){this._setProperty(k,y);
}else{throw new Error("Text wrapping is only support by textareas!");
}return this;
},getWrap:function(){if(this.__lq===i){return this._getProperty(k);
}else{throw new Error("Text wrapping is only support by textareas!");
}}}});
})();
...
}},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{input:1,change:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_DOMNODE,IGNORE_CAN_HANDLE:false},members:{__lt:false,__lu:null,__lv:null,canHandleEvent:function(x,y){var z=x.tagName.toLowerCase();

if(y===v&&(z===v||z===p)){return true;
}
if(y===w&&(z===v||z===p||z===j)){return true;
}return false;
},registerEvent:qx.core.Variant.select(u,{"mshtml":function(A,B,C){if(!A.__lw){var D=A.tagName.toLowerCase();
var E=A.type;
...
}},"default":function(F,G,H){if(G===v){this.__lx(F);
...
}}}}}),__lx:qx.core.Variant.select(u,{"mshtml":null,"webkit":function(I){var J=I.tagName.toLowerCase();
...
}}),unregisterEvent:qx.core.Variant.select(u,{"mshtml":function(M,N){if(M.__lw){var O=M.tagName.toLowerCase();
var P=M.type;
...
}}},"default":function(R,S){if(S===v){this.__lx(R);
...
}}}}),__ly:qx.core.Variant.select(u,{"mshtml":null,"webkit":function(T){var U=T.tagName.toLowerCase();
...
}}),_onKeyPress:qx.core.Variant.select(u,{"mshtml|opera":function(e,X){if(e.keyCode===13){if(X.value!==this.__lv){this.__lv=X.value;
qx.event.Registration.fireEvent(X,w,qx.event.type.Data,[X.value]);
}}},"default":null}),_onKeyDown:qx.core.Variant.select(u,{"opera":function(e){if(e.keyCode===13){this.__lt=true;
}},"default":null}),_onKeyUp:qx.core.Variant.select(u,{"opera":function(e){if(e.keyCode===13){this.__lt=false;
}},"default":null}),_onBlur:qx.core.Variant.select(u,{"opera":function(e){if(this.__lu){window.clearTimeout(this.__lu);
}},"default":null}),_onInput:qx.event.GlobalError.observeMethod(function(e){var Y=qx.bom.Event.getTarget(e);
if(!this.__lt){if(qx.core.Variant.isSet(u,m)){this.__lu=window.setTimeout(function(){qx.event.Registration.fireEvent(Y,v,qx.event.type.Data,[Y.value]);
},0);
...
qx.Class.define(e,{statics:{__lz:{text:1,textarea:1,select:1,checkbox:1,radio:1,password:1,hidden:1,submit:1,image:1,file:1,search:1,reset:1,button:1},create:function(w,x,y){{};
...
(function(){var a="eyeos.theme.Color";
...
(function(){var a="eyeos.theme.Appearance";
...
(function(){var a="eyeos.theme.Font";
qx.Theme.define(a,{extend:qx.theme.modern.Font,fonts:{}});
})();
(function(){var i="Number",h="_applyInsets",g="abstract",f="insetRight",e="insetTop",d="insetBottom",c="qx.ui.decoration.Abstract",b="shorthand",a="insetLeft";
qx.Class.define(c,{extend:qx.core.Object,implement:[qx.ui.decoration.IDecorator],type:g,properties:{insetLeft:{check:i,nullable:true,apply:h},insetRight:{check:i,nullable:true,apply:h},insetBottom:{check:i,nullable:true,apply:h},insetTop:{check:i,nullable:true,apply:h},insets:{group:[e,f,d,a],mode:b}},members:{__lA:null,_getDefaultInsets:function(){throw new Error("Abstract method called.");
},_isInitialized:function(){throw new Error("Abstract method called.");
},_resetInsets:function(){this.__lA=null;
},getInsets:function(){if(this.__lA){return this.__lA;
}var j=this._getDefaultInsets();
return this.__lA={left:this.getInsetLeft()==null?j.left:this.getInsetLeft(),right:this.getInsetRight()==null?j.right:this.getInsetRight(),bottom:this.getInsetBottom()==null?j.bottom:this.getInsetBottom(),top:this.getInsetTop()==null?j.top:this.getInsetTop()};
...
}},properties:{backgroundColor:{check:b,nullable:true,apply:c}},members:{__lC:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
...
}},properties:{innerColor:{check:h,nullable:true,apply:j},innerOpacity:{check:o,init:1,apply:j},outerColor:{check:h,nullable:true,apply:j},backgroundColor:{check:h,nullable:true,apply:j}},members:{__lD:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__lD;
},_applyStyle:function(){{};
},getMarkup:function(){if(this.__lD){return this.__lD;
...
}},properties:{width:{check:b,init:0,apply:g},style:{nullable:true,check:[k,j,h,i],init:k,apply:o},color:{nullable:true,check:m,apply:o},backgroundColor:{check:m,nullable:true,apply:o}},members:{__lE:null,_getDefaultInsets:function(){var s=this.getWidth();
return {top:s,right:s,bottom:s,left:s};
},_isInitialized:function(){return !!this.__lE;
},getMarkup:function(){if(this.__lE){return this.__lE;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__lF=new qx.ui.decoration.css3.BorderImage();

if(n){this.__lG(n);
}}else{this.__lF=new qx.ui.decoration.GridDiv(n);
}
if(o!=null){this.__lF.setInsets(o);
}},properties:{baseImage:{check:c,nullable:true,apply:h},insetLeft:{check:m,nullable:true,apply:l},insetRight:{check:m,nullable:true,apply:l},insetBottom:{check:m,nullable:true,apply:l},insetTop:{check:m,nullable:true,apply:l},insets:{group:[i,j,g,a],mode:e}},members:{__lF:null,getMarkup:function(){return this.__lF.getMarkup();
},resize:function(p,q,r){this.__lF.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__lF.getInsets();
},_applyInsets:function(u,v,name){var w=f+qx.lang.String.firstUp(name);
this.__lF[w](u);
},_applyBaseImage:function(x,y){if(this.__lF instanceof qx.ui.decoration.GridDiv){this.__lF.setBaseImage(x);
}else{this.__lG(x);
}},__lG:function(z){var B,D;
this.__lF.setBorderImage(z);
...
(function(){var a="eyeos.theme.Decoration";
qx.Theme.define(a,{extend:qx.theme.modern.Decoration,decorations:{}});
})();
(function(){var a="eyeos.theme.Theme";
qx.Theme.define(a,{meta:{color:eyeos.theme.Color,decoration:eyeos.theme.Decoration,font:eyeos.theme.Font,icon:qx.theme.icon.Tango,appearance:eyeos.theme.Appearance}});
})();
...
var V=this.getFill()&&this.__lI()?p:b;
this.__lH=[G,qx.bom.element.Style.compile({"borderImage":B+S+y+T.join(f)+V+f+U,borderStyle:I,borderColor:s,position:D,lineHeight:0,fontSize:0,overflow:w,boxSizing:v,borderWidth:T.join(N)+g}),H].join(b);
return this.__lH;
},__lI:function(){var X=this.__lK(d);
...
},__lJ:[M,F,J,z,m],__lK:function(Y){var ba=document.documentElement.style;

if(ba[Y]!==undefined){return Y;
}
for(var i=0,l=this.__lJ.length;i<l;i++){var bb=this.__lJ[i]+qx.lang.String.firstUp(Y);
...
}},properties:{baseImage:{check:p,nullable:true,apply:r}},members:{__lL:null,__lM:null,__lN:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
...
D.push(b);
return this.__lL=D.join(o);
},resize:function(E,F,G){var H=this.__lN;
...
var O=Q[1];
var N=Q[2];
var M=this.__lM={tl:O+u+N,t:O+v+N,tr:O+d+N,bl:O+m+N,b:O+q+N,br:O+w+N,l:O+c+N,c:O+k+N,r:O+t+N};
this.__lN=this._computeEdgeSizes(M);
...
}},destruct:function(){this.__lL=this.__lM=this.__lN=null;
}});
})();
